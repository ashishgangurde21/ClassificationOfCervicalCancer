...
model <- train(Biopsy ~ IUD..years. + Smokes..years. +Age+Smokes+STDs+Number.of.sexual.partners+Num.of.pregnancies+IUD+Dx+Hormonal.Contraceptives+Schiller+Hinselmann+Citology, data=training_balanced, method="lvq", preProcess="scale", trControl=control)
